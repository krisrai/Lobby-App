        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                scope.params.settings().$scope.$on('ngTableAfterReloadData', function () {
                    if(scope.params.total()===scope.params.count()){scope.params.page(1)}
...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/pager.html', '<div class="ng-cloak ng-table-pager"> <div ng-if="params.settings().counts.length" class="ng-table-counts btn-group pull-right"> <button ng-repeat="count in params.settings().counts" type="button" ng-class="{\'active\':params.count()==count}" ng-click="params.count(count)" class="btn btn-default"> <span ng-bind="count"></span> </button> </div> <ul class="pagination ng-table-pagination"> <li ng-class="{\'disabled\': !page.active}" ng-repeat="page in pages" ng-switch="page.type"> <a ng-switch-when="prev" ng-click="params.page(page.number)" href="">Previous</a><a ng-switch-when="next" ng-click="params.page(page.number)" href="">Next</a> </li><li class="disabled" ng-if="pages.length===0"> <a href="">Previous</a></li><li class="disabled" ng-if="pages.length===0"><a href="">Next</a> </li> </ul> </div> ');
}]);
    return app;
}));